...
export default function DashboardPage() {
  ...
  const [layouts, setLayouts] = useState({
    ...
    sm: [
      ...
      { i: 'weather', x: 0, y: 2, w: 6, h: 8 },
      { i: 'deliveries', x: 0, y: 10, w: 6, h: 2 },
      { i: 'sqm', x: 0, y: 12, w: 6, h: 2 },
      { i: 'pending', x: 0, y: 14, w: 6, h: 2 },
      { i: 'difficult', x: 0, y: 16, w: 6, h: 2 },
      { i: 'week-delivered', x: 0, y: 18, w: 6, h: 2 },
      { i: 'week-scheduled', x: 0, y: 20, w: 6, h: 2 },
      { i: 'week-difficult', x: 0, y: 22, w: 6, h: 2 },
      { i: 'actions', x: 0, y: 24, w: 6, h: 3 },
    ],
  });
